      ...
      <div use:scrollable={{ class: content() }}>
        ...
        <Buttons>
            ...
            <Switch fallback={null}>
              <Match when={showLoungeButton && isInLounge}>
                <CategoryButton
                  ...
                  icon={<MdGroups3 />}
                >
                  <Trans>Go to the Mirket Lounge</Trans>
                </CategoryButton>
              </Match>
              <Match when={showLoungeButton && !isInLounge}>
                <CategoryButton
                  ...
                  icon={<MdGroups3 />}
                >
                  <Trans>Join the Mirket Lounge</Trans>
                </CategoryButton>
              </Match>
            </Switch>
            <CategoryButton
          ...
          <SeparatedColumn>
            ...
            >
              <Trans>Give feedback on Mirket</Trans>
            </CategoryButton>
            <CategoryButton
